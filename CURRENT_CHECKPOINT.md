...
- Internet research may explicitly seek ordinary web sources, current developments, counterexamples, and YouTube/video/transcript leads. YouTube discovery currently occurs through the governed web-research route; richer direct transcript ingestion remains governed by the existing media/transcript capability when a usable video source is available.
